...
print("GPS(latitude: \(somePlace.latitude), longitude: \(somePlace.longitude))")
...
let favoriteBook = Book(title: "The Great Gatsby", author: "F. Scott Fitzgerald", pages: 300, price: 150)

print("Book(title: \(favoriteBook.title), author: \(favoriteBook.author), pages: \(favoriteBook.pages), price: \(favoriteBook.price))")
...
var lenovo = Laptop(yearPurchased: 2017)
var macbook = Laptop(screenSize: 15, repairCount: 3, yearPurchased: 2021)
...
let myHeight = Height(centimeters: 162)
