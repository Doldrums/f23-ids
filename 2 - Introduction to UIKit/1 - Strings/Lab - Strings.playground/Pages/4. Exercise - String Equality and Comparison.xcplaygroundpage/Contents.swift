...
if nameInCaps.lowercased() == name.lowercased() {
    print("\(nameInCaps.lowercased()) and \(nameInCaps.lowercased()) are the same.")
} else {
    print("\(nameInCaps.lowercased()) and \(nameInCaps.lowercased()) are not the same.")
}
